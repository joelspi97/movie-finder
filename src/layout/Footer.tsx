    ...
    <footer id="footer" className="footer container-fluid">
      ...
      <Row className="justify-content-around">
        ...
        >
          ...
          <a className="d-inline-block rounded" href="https://github.com/joelspi97/movie-list"> Visit this project's GitHub repository!</a>
        </Col>
        <Col
          className="footer__link-wrapper d-flex flex-column justify-content-evenly align-items-center rounded-pill mb-4 py-4 px-5"
          sm={12} md={5} lg={4}
        >
          ...
          <a className="d-inline-block rounded" href="https://joelspinelli.herokuapp.com/"> Check my portfolio!</a>
        </Col>
      </Row>
